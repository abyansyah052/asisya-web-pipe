...
export default function PsychologistDashboard() {
    ...
    const sendVerificationCode = async () => {
        setSendingCode(true);
        try {
            const res = await fetch('/api/psychologist/exams/send-verification', {
                method: 'POST',
    ...
    const handleDeleteExam = async () => {
        ...
        setDeleting(true);
        try {
            const res = await fetch('/api/psychologist/exams/delete', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const res = await fetch('/api/psychologist/exams/upload', {
                method: 'POST',
                body: formData,
            });
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <nav className="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center shadow-sm sticky top-0 z-10 backdrop-blur-sm bg-white/95">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-gray-900">Portal Psikolog</h1>
                        <p className="text-xs text-gray-500">Sistem Ujian Online Asisya</p>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    <div className="hidden md:flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-full">
                        ...
                        <span className="text-gray-700 text-sm font-medium">Psikolog</span>
                    </div>
                    <button
            ...
            <main className="max-w-7xl mx-auto p-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-800">Dashboard Psikolog</h2>
                        <p className="text-gray-500 text-sm">Kelola ujian dan pantau peserta</p>
                    </div>

                    <div className="flex flex-wrap gap-3">
                        <button
                            onClick={() => router.push('/psychologist/candidates')}
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                    <h3 className="font-semibold text-gray-700 mb-4">Upload Soal dari Excel</h3>
                    <div className="flex flex-wrap gap-3">
                        <button
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                        <h3 className="font-semibold text-gray-700">Daftar Ujian</h3>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="p-12 text-center">
                            ...
                            <p className="text-gray-500 mt-1">Silakan upload file excel atau buat ujian manual.</p>
                        </div>
                    ) : (
                    ...
                    <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full mx-4">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 mb-6">
                                Untuk menghapus ujian ini, kami akan mengirimkan kode verifikasi ke email Anda.
                            </p>
