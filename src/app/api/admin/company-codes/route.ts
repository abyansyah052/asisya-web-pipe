...
// GET - List active company codes for dropdown
export async function GET(_request: NextRequest) {
    try {
        ...
        // For regular admin, only show codes for their organization OR global codes (no org)
        // For super_admin, show all codes
        let query = `
            SELECT 
                cc.id,
                cc.code,
